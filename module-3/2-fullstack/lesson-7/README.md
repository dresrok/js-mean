# Clase 7: Testing end-to-end con Cypress

Esta clase aborda los conceptos fundamentales de Testing end-to-end con Cypress, elementos esenciales para construir aplicaciones web modernas.

## Estructura del contenido

- **docs/**: Presentación teórica sobre Testing end-to-end con Cypress
