# Clase 6: Seguridad en aplicaciones MEAN: OWASP y prácticas seguras

Esta clase aborda los conceptos fundamentales de Seguridad en aplicaciones MEAN: OWASP y prácticas seguras, elementos esenciales para construir aplicaciones web modernas.

## Estructura del contenido

- **docs/**: Presentación teórica sobre Seguridad en aplicaciones MEAN: OWASP y prácticas seguras
