...
incidentsRouter.route('/')
  .get(cacheMiddleware, listIncidents) // Requiere INCIDENTS_READ_SELF o INCIDENTS_READ_ALL (verificado en el controlador)
...
incidentsRouter.route('/:id')
  .get(cacheMiddleware, getIncident) // Requiere INCIDENTS_READ_SELF o INCIDENTS_READ_ALL (verificado en el controlador)
