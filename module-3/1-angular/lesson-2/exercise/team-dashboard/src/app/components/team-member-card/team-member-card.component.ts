...
import { SkillBadgeComponent } from '../skill-badge/skill-badge.component'; // importar el componente SkillBadgeComponent
import { AvailabilityIndicatorComponent } from '../availability-indicator/availability-indicator.component'; // importar el componente AvailabilityIndicatorComponent
import { TeamMember } from '../../models/team-member.interface';

@Component({
  selector: 'app-team-member-card',
  imports: [CommonModule, SkillBadgeComponent, AvailabilityIndicatorComponent], // añadir ambos componente al array de imports
