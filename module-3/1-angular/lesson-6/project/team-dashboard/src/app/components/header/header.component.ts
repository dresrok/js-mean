...
@Component({
  ...
  template: `
    <header class="dashboard-header">
      ...
      <nav class="main-nav">
        <ul class="nav-links">
          <li><a routerLink="/dashboard/form-control" routerLinkActive="active">Form Control</a></li>
          <li><a routerLink="/dashboard/form-group" routerLinkActive="active">Form Group</a></li>
          <li><a routerLink="/dashboard/validators" routerLinkActive="active">Validators</a></li>
